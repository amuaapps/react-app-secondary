/**
 * Main Bicep Template - React App Core Azure Infrastructure
 * 
 * Deploys Azure Container Apps infrastructure for hosting the core application
...
param projectName string = 'react-app-core'
